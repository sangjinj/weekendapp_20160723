...
public class GuestListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<MemberBean> list = service.guestlist();
        lv_memberList.setAdapter(new GuestAdapter(this, list));
        lv_memberList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int i, long l) {
                ...
                Toast.makeText(GuestListActivity.this, "선택한 이름" + memberBean.getName(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(GuestListActivity.this, DetailActivity.class);
